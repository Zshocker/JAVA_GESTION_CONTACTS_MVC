...
public class MainApp
{
    ...
    public MainApp()
    {
        Add_Contact_butt.addActionListener(new ActionListener() {
            @Override
        ...
        Update_Contact_butt.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Contact c=null;
        ...
        ComboUpdate.addItemListener(new ItemListener() {
            @Override
